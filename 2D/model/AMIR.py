...
# https://github.com/Yaziwel/All-In-One-Medical-Image-Restoration-via-Task-Adaptive-Routing
import torch
...
class AMIR(nn.Module):
    ...
    def forward(self, inp_img, target_img=None): 
        ...
        if target_img == None:
            ...
            return self.loss_fun(out_dec_level1, target_img) + 0.001*loss_importance
